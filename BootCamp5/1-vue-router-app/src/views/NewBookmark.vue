<template>
  <div class="form-area card border p-2">
    <div class="mb-3">
      ...
      <input type="text" v-model="userData.title" class="form-control" id="title" placeholder="Course Çalışmaları" />
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
      ...
      <textarea class="form-control" v-model="userData.description" placeholder="Güzel" id="description" rows="3"></textarea>
    </div>
