<template>
  <aside class="sidebar">
    <!-- href # ini sürekli yukarı koymasını engellemek için click.prevent dedik -->
...
<script>
export default {
  // burada emits tamamen dokümantasyon amaçlı
  emits: ["category-changed"],
  // Normalde bilgi tekrarı olan yerlerde yapılması gereken şey bunları state e aktarmamız ama burada yapmadık küçük bir işlem olduğundan
  data() {
    return {
      categoryList: [],
    };
