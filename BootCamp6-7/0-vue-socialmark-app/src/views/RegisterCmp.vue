...
export default {
  ...
  methods: {
    // onsave kısmında cryptejs ile enc ve dec işlemlerinin örneği gösterilmektedir.
    onSave() {
      ...
      this.$appAxios
        .post("/users", {
          ...this.userData,
          password,
          // Burada password : cryptedPassword gibi de kullanabiliyoruz aklında bulunsun bir değişkenden değer atamak istersen
        })
